function domReady() {
  ...
  */
  ...
  function storeHighscore() {
    ...
    a.text(`${firstScore} Langkah`);
    b.text(`${secondScore} Langkah`);
    c.text(`${thirdScore} Langkah`);
    ...
    if (move < firstScore) {
      ...
      a.text(`${localStorage.getItem('firstScore')} Langkah`);
      a.css({color : 'gold'});
      ...
      b.text(`${localStorage.getItem('secondScore')} Langkah`);
      b.css({color : 'gold'});
      scoredMessage.text('New high score!');
      scoredMessage.addClass('decoration');
      ...
      c.text(`${localStorage.getItem('thirdScore')} Langkah`);
      c.css({color : 'gold'});
      scoredMessage.text('New high score!');
      scoredMessage.addClass('decoration');
    }
  ...
  function winGame() {
    ...
    if (matchedCardsArr.length === 16) {
      ...
      window.setTimeout(function () {
        ...
        // number of stars
        if (starsNumber === 1) {
          $('#stars-info').text(starsNumber + ' bintang');
        } else {
          $('#stars-info').text(starsNumber + ' bintang');
        }
